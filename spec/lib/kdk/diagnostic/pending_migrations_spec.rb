...
RSpec.describe KDK::Diagnostic::PendingMigrations do
  ...
  def stub_pending_migrations(success)
    ...
    allow(KDK::Dependencies).to receive_messages(asdf_available?: false, tool_version_manager_available?: false, homebrew_available?: false, linux_apt_available?: false)
