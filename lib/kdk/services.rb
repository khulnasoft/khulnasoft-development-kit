...
module KDK
  ...
  module Services
    ...
    # @see https://github.com/khulnasoft/khulnasoft-development-kit/-/issues/904
    class Legacy
      ...
      def all
        KDK::Output.abort 'KDK services appear missing, have you run `kdk install`?' unless @procfile_path.exist?
