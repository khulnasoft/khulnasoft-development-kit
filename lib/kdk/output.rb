...
module KDK
  module Output
    ...
    module ClassMethods
      ...
      # Borrowed from https://github.com/khulnasoft/khulnasoft/-/blob/0a06e1dcb2474f866e2f335cee2d0cb3c6886db3/lib/khulnasoft/encoding_helper.rb#L165-172
      ...
      def prompt(message, raise_interrupt: false)
