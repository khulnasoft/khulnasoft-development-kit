...
khulnasoft-topology-service-make-deps-install: khulnasoft-topology-service-tool-install
	@echo
	@echo "${DIVIDER}"
	@echo "Performing make deps steps for ${khulnasoft_topology_service_dir}"
	@echo "${DIVIDER}"
	$(Q)support/tool-version-manager-exec ${khulnasoft_topology_service_dir} make deps

.PHONY: khulnasoft-topology-service-tool-install
khulnasoft-topology-service-tool-install:
