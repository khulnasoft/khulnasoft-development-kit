          ...
          khulnasoft:
            cell:
              ...
              topology_service_client:
                ...
                enabled: true
                ca_file: #{KDK.config.khulnasoft.cell.topology_service_client.ca_file}
                private_key_file: #{KDK.config.khulnasoft.cell.topology_service_client.private_key_file}
                certificate_file: #{KDK.config.khulnasoft.cell.topology_service_client.certificate_file}
                tls:
                  enabled: false
            rails:
        ...
        <<~YAML
          ...
          khulnasoft:
            cell:
              ...
              database: { skip_sequence_alteration: false }
              topology_service_client:
                address: #{KDK.config.khulnasoft.cell.topology_service_client.address}
                enabled: true
      ...
      context 'when cells exist' do
        ...
        context 'when cells do not exist', :hide_output do
          it 'writes cell specific configuration' do
            ...
            expect_kdk_command(*%w[git remote get-url origin], success: false)
            expect_kdk_command(*%w[git remote set-url origin https://github.com/khulnasoft/khulnasoft-development-kit.git], chdir: cell_dir(2))
            ...
            expect_kdk_command(*%w[git remote get-url origin], stdout: "https://khulnasoft.com/khulnasoft-community/khulnasoft-org/khulnasoft-development-kit.git")
            ...
            expect_kdk_command(*%w[git remote get-url origin], success: false)
            expect_kdk_command(*%w[git remote set-url origin https://github.com/khulnasoft/khulnasoft-development-kit.git], chdir: cell_dir(4))
