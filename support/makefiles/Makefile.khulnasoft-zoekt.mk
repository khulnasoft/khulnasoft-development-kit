...
khulnasoft-zoekt-indexer/bin/khulnasoft-zoekt: khulnasoft-zoekt-tool-install
	@echo
	@echo "${DIVIDER}"
	@echo "Building khulnasoft-org/khulnasoft-zoekt version ${khulnasoft_zoekt_indexer_version}"
	@echo "${DIVIDER}"
	$(Q)support/tool-version-manager-exec khulnasoft-zoekt-indexer $(MAKE) build_unified ${QQ}
