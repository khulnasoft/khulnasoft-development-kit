...
module KDK
  module Diagnostic
    ...
    # due to https://github.com/khulnasoft/khulnasoft-development-kit/-/issues/2222.
    class Ruby < Base
      TITLE = 'Ruby'
      ...
      def cxx_compiler_error_message
        <<~MESSAGE
          ...
          this directory. See https://github.com/khulnasoft/khulnasoft-development-kit/-/blob/main/doc/troubleshooting/ruby.md#cannot-compile-c-native-extensions
        MESSAGE
      end
    end
  end
