...
.PHONY: khulnasoft-http-router/wrangler.kdk.toml
khulnasoft-http-router/wrangler.kdk.toml: 
ifeq ($(khulnasoft_http_router_enabled),true)
	$(Q)rake khulnasoft-http-router/wrangler.kdk.toml
else
	@true
endif
...
.PHONY: khulnasoft-db-migrate
khulnasoft-db-migrate: ensure-databases-running
	$(Q)rake khulnasoft-db-migrate
