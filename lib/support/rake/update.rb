    ...
    class Update
      ...
      def self.optional_tasks(config)
        [
          ...
          make_task('khulnasoft-docs-update', enabled: config.khulnasoft_docs.enabled?),
          make_task('khulnasoft-docs-hugo-update', enabled: config.khulnasoft_docs_hugo.enabled?),
          ...
          make_task('khulnasoft-zoekt-indexer-update', enabled: config.zoekt.enabled?),
