...
class AsdfToMise
  ...
  def enable_mise
    ...
    KDK::Command::Config.new.run(['set', 'tool_version_manager.enabled', 'true'])
  end
  ...
  def display_success_message
    ...
    KDK::Output.puts
    KDK::Output.notice('If you encounter any issues with mise, see our troubleshooting guide: https://github.com/khulnasoft/khulnasoft-development-kit/-/blob/main/doc/troubleshooting/mise.md')
  end
