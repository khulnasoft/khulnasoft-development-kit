...
mise x -- kdk install blobless_clone=true khulnasoft_repo="https://khulnasoft.com/khulnasoft-community/khulnasoft-org/khulnasoft.git" telemetry_user="kdk-in-a-box"
...
mise x -- kdk truncate-legacy-tables
mise x -- kdk stop
