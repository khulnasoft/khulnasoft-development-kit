...
module KDK
  module Command
    ...
    class BaseCommand
      ...
      HelpItem = Struct.new(:description, :subcommand, keyword_init: true)
      ...
      def self.help(subcommand = nil, description = nil)
        @help ||= []
        return @help unless subcommand
        ...
        @help << HelpItem.new(description: description, subcommand: subcommand)
      end
      ...
      def sandbox_manager
        @sandbox_manager ||= SandboxManager.new(config: config)
      end
    end
  end
end
