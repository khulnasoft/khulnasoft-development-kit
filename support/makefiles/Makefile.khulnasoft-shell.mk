...
ifeq ($(khulnasoft_shell_skip_setup),true)
	...
	$(Q)$(MAKE) khulnasoft-shell/.git khulnasoft-shell-tool-install khulnasoft-shell/config.yml .khulnasoft-shell-bundle khulnasoft-shell/.khulnasoft_shell_secret $(sshd_hostkeys) khulnasoft-shell/bin/khulnasoft-shell
endif
...
.PHONY: khulnasoft-shell-tool-install
khulnasoft-shell-tool-install:
