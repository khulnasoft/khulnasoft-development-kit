...
module KDK
  class PackageHelper
    ...
    attr_reader :package_basename, :package_name, :package_path, :package_version, :project_path, :upload_path, :download_path, :platform_specific, :project_id, :token
    ...
    def extract_package
      ...
      Dir.mktmpdir do |tmp_dir|
        ...
        copy_entries(tmp_download_path, download_path)

        KDK::Output.success("Package extracted successfully to #{download_path}")
