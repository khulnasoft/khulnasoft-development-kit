...
module KDK
  module Diagnostic
    class MacPorts < Base
      ...
      POSTGRESQL_COMPILATION_PROBLEM_ISSUE = 'https://github.com/khulnasoft/khulnasoft-development-kit/-/issues/1362'
      MAC_PORTS_UNINSTALLATION_LINK = 'https://guide.macports.org/chunked/installing.macports.uninstalling.html'
      MIGRATE_TO_ASDF_LINK = 'https://github.com/khulnasoft/khulnasoft-development-kit/-/blob/main/doc/migrate_to_asdf.md'
