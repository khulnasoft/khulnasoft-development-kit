    ...
    context 'with asdf' do
      ...
      describe '#bin_path_or_fallback' do
        it 'returns latest version' do
          ...
          expect(subject.bin_path_or_fallback).to eq('/home/on/the/range/.asdf/installs/postgres/14.9/bin')
        end
        ...
        context 'when asdf fails' do
          before do
            ...
            shellout_pg = kdk_shellout_double(run: '/home/on/the/range/.local/share/mise/installs/postgres/14.9/bin', exit_code: 0)
          ...
          it 'returns the output of `pg_config --bindir`' do
            expect(subject.bin_path_or_fallback).to eq('/home/on/the/range/.local/share/mise/installs/postgres/14.9/bin')
          end
        end
      end
