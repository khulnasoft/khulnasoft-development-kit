...
namespace :update do
  ...
  task 'khulnasoft-setup' => %w[
    ...
    make:khulnasoft-tool-install
    khulnasoft-dependencies
    khulnasoft-post-dependencies
  ]

  multitask 'khulnasoft-dependencies' => %w[
    make:.khulnasoft-bundle
    make:.khulnasoft-yarn
  ]

  multitask 'khulnasoft-post-dependencies' => %w[
