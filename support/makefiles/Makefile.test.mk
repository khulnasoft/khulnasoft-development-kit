...
test: kdk_bundle_install
	@support/tool-version-manager-exec . bundle exec lefthook run pre-push
...
ifeq ($(BUNDLE),)
rubocop:
	@echo "ERROR: Bundler is not installed, please ensure you've bootstrapped your machine. See https://github.com/khulnasoft/khulnasoft-development-kit/blob/main/doc/index.md for more details"
	@false
else
rubocop: kdk_bundle_install
	@echo -n "RuboCop: "
	@support/tool-version-manager-exec . bundle exec $@ --config .rubocop-kdk.yml --parallel
endif
...
rspec: kdk_bundle_install
	@echo -n "RSpec: "
	@support/tool-version-manager-exec . bundle exec $@ ${RSPEC_ARGS}
endif
...
yarn-install:
ifeq ($(YARN)),)
	@echo "ERROR: YARN is not installed, please ensure you've bootstrapped your machine. See https://github.com/khulnasoft/khulnasoft-development-kit/blob/main/doc/index.md for more details"
	@false
else
