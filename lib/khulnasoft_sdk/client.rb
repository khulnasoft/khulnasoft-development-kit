...
module KhulnasoftSDK
  class Client
    SCHEMAS = {
      custom_event: 'iglu:com.khulnasoft/custom_event/jsonschema/1-0-0',
      user_context: 'iglu:com.khulnasoft/user_context/jsonschema/1-0-0'
    }.freeze
    DEFAULT_TRACKER_NAMESPACE = 'khulnasoft'
    USERAGENT = "KhulnaSoft Analytics Ruby SDK/#{KhulnasoftSDK::VERSION}"
    ...
    def identify(user_id, user_attributes = {})
      KhulnasoftSDK::CurrentUser.user_id = user_id
      KhulnasoftSDK::CurrentUser.user_attributes = user_attributes
    end
    ...
    def set_user_id_on_subject(subject)
      user_id = KhulnasoftSDK::CurrentUser.user_id

      subject.set_user_id(user_id) if user_id
    end

    def set_user_context(track_arguments)
      user_attributes = KhulnasoftSDK::CurrentUser.user_attributes || {}
