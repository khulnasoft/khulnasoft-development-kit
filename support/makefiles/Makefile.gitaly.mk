...
gitaly_version = $(shell support/resolve-dependency-commitish "${khulnasoft_development_root}/khulnasoft/GITALY_SERVER_VERSION")
...
ifeq ($(asdf_opt_out),false)
	...
	@echo "${DIVIDER}"
	$(Q)cd ${gitaly_dir} && egrep '^nodejs ' .tool-versions | awk '{ print $$1 " " $$2 }' | xargs -L 1 asdf install
	...
	@echo "${DIVIDER}"
	$(Q)cd ${gitaly_dir} && mise install -y
else
	@true
endif
