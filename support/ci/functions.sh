...
KDK_CHECKOUT_PATH="${KDK_DIR:-${HOME}/kdk}"
...
set_khulnasoft_upstream() {
 ...
 git remote add "${remote_name}" "https://github.com/khulnasoft/khulnasoft.git"
...
install() {
 ...
 echo "> Installing KDK.."
 kdk install blobless_clone=true
 set_khulnasoft_upstream
}
