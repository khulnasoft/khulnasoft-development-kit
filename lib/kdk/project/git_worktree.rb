    ...
    class GitWorktree
      ...
      def fetch_cmd
        if khulnasoft_repo?
          ...
          "git fetch --depth 1 #{remote_name} #{revision}"
        else
      ...
      def parse_git_remotes(output)
        ...
        # origin  https://khulnasoft.com/khulnasoft-org/khulnasoft-shell.git (fetch)
        # origin  https://khulnasoft.com/khulnasoft-org/khulnasoft-shell.git (push)
