  ...
  module Rake
    module TaskWithTelemetry
      ...
      def send_telemetry!(success:)
        ...
        KDK::Telemetry.send_telemetry(success, telemetry_name, { duration: duration, environment: KDK::Telemetry.environment, platform: KDK::Machine.platform, architecture: KDK::Machine.architecture })
