...
- `khulnasoft-qa-resources`: Use this project for composing and running the [Auto DevOps](https://khulnasoft.com/khulnasoft-org/khulnasoft/-/tree/master/qa/qa/specs/features/browser_ui/7_configure/auto_devops) tests.
