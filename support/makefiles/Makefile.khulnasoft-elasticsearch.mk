...
khulnasoft-elasticsearch-indexer/bin/khulnasoft-elasticsearch-indexer: khulnasoft-elasticsearch-indexer/.git/pull khulnasoft-elasticsearch-indexer-tool-install
	@echo
	@echo "${DIVIDER}"
	@echo "Building khulnasoft-org/khulnasoft-elasticsearch-indexer version ${khulnasoft_elasticsearch_indexer_version}"
	@echo "${DIVIDER}"
	$(Q)support/tool-version-manager-exec khulnasoft-elasticsearch-indexer $(MAKE) build ${QQ}
...
khulnasoft-elasticsearch-indexer-tool-install:
