  ...
  module PackageConfig
    PROJECTS = {
      ...
      workhorse: {
        ...
        upload_path: 'build',
        download_paths: ['khulnasoft/workhorse', 'khulnasoft/tmp/tests/khulnasoft-workhorse'],
        platform_specific: true
      },
      graphql_schema: {
      ...
      openbao: {
        ...
        project_path: 'openbao-internal',
        upload_path: 'bin',
        download_paths: ['openbao/bin'],
        platform_specific: true
      },
      kdk_preseeded_db: {
        package_name: 'kdk_preseeded_db',
        project_path: '.',
        upload_path: '.', # we upload this separately
        download_paths: ['.'],
        platform_specific: false
      }
    }.freeze
