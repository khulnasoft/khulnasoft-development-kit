...
module KDK
  module Command
    ...
    class Pristine < BaseCommand
      ...
      help 'Reset KDK state. Deletes caches, temporary files reinstalls dependencies. Does not delete data'
      ...
      def kdk_tmp_clean
        ...
        if $stdin.tty?
          notice("This will delete KDK backups and logs. Continue? [y/N]")
          answer = $stdin.gets&.chomp&.downcase
          return true unless answer == 'y' || answer == 'yes'
        end
