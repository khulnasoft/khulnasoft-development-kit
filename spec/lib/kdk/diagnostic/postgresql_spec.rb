      ...
      context 'when unsuccessful' do
        ...
        it 'returns help message' do
          expected = <<~MESSAGE
            ...
            https://github.com/khulnasoft/khulnasoft-development-kit/-/blob/main/doc/howto/postgresql.md#upgrade-postgresql
          MESSAGE
    ...
    context 'socket creation testing' do
      ...
      context 'ldflags testing' do
        ...
        context 'when unsuccessful' do
          ...
          before do
            allow(subject).to receive_messages(psql_version: '16.11', valid_ldflags?: false)
          ...
          it 'returns help message' do
            expected = <<~MESSAGE
              ...
              mise uninstall postgres 16.11 && mise install postgres 16.11
            MESSAGE
